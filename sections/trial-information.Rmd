...
trial_info <- tibble(
  ...
  Description = c(
    ...
    paste0(
      ...
      "Cohort 2 closed for poor accrual before enrollment. Under protocol v3.0, Cohort 1 used two schedules: ",
      ...
      " enrolled patients received a fixed 2-week colchicine course (phase 0 design), without transitioning patients already on the original schedule. ",
