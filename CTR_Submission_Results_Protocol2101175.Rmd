...
```{r tumor-waterfall-plot, fig.cap=fig_cap("Best percent change in target-lesion sum of diameters (SOD) from baseline among all enrolled patients (N = 11). Bars are shown for patients with ≥2 on-study scan sets (n = 5); patients without paired post-baseline target-lesion measurements are labeled NE (not evaluable for % change). Negative values indicate tumor shrinkage. Abbreviations: SOD, sum of diameters; NE, not evaluable.")}
